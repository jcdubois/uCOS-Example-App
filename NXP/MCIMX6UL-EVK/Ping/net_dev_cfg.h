...
extern  const  NET_DEV_CFG_ETHER  NetDev_Cfg_MACNet_ETHER1;   /*   Example Ethernet     configuration for device A, #1  */
extern  const  NET_PHY_CFG_ETHER  NetPhy_Cfg_MACNet_ETHER1;   /*   Example Ethernet Phy configuration for device A, #1  */

extern  const  NET_DEV_CFG_ETHER  NetDev_Cfg_MACNet_ETHER2;   /*   Example Ethernet     configuration for device B, #1  */
extern  const  NET_PHY_CFG_ETHER  NetPhy_Cfg_MACNet_ETHER2;   /*   Example Ethernet Phy configuration for device B, #1  */
