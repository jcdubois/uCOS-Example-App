...
#define  NET_CFG_IF_RX_Q_SIZE                  200u             /*Configure RX queue size (See Note #1).                */
#define  NET_CFG_IF_TX_DEALLOC_Q_SIZE          200u             /*Configure TX queue size (See Note #2).                */
...
#define  NET_TMR_CFG_TASK_FREQ                    1u            /* Configure Timer Task frequency   (see Note #2).      */
...
#define  NET_ARP_CFG_CACHE_NBR                 10u              /* Configure ARP cache size.                            */
...
#define  NET_MCAST_CFG_HOST_GRP_NBR_MAX         8u              /* Configure maximum number of Multicast groups.        */
...
#define  NET_SOCK_CFG_SOCK_NBR_TCP              8u              /* Configure number of TCP connections.                 */
...
#define  NET_SOCK_CFG_CONN_ACCEPT_Q_SIZE_MAX    6u              /* maximum size. (See Note # 1)                         */


                                                                /* Configure sockets' buffer sizes in number of octets  */
                                                                /* (see Note #2):                                       */
#define  NET_SOCK_CFG_RX_Q_SIZE_OCTET            2 * 1460u      /* Configure socket receive  queue buffer size.         */
#define  NET_SOCK_CFG_TX_Q_SIZE_OCTET           15 * 1460u      /* Configure socket transmit queue buffer size.         */
